...
public class Constants {
    ...
    /** QQ正则 */
    public static final String checkQQ = "[1-9][0-9]{4,11}";
    /** 邮箱正则 */
    public static final String checkEmail = "^([a-z0-9A-Z]+[-|\\.]?)+[a-z0-9A-Z]@([a-z0-9A-Z]+(-[a-z0-9A-Z]+)?\\.)+[a-zA-Z]{2,}$";
    /** 微信正则 */
    public static final String checkWechat = "^[a-zA-Z0-9_-]{5,20}$";
    /** 座机正则 */
    public static final String checkTel = "^[0][0-9]{9,12}$";
    /** 身份证号 */
